(define-module (minikanren binary-trie)
  #:export (empty-trie trie-lookup trie-fold trie-insert trie-insert/merge trie-lookup/delete trie-size binary-trie->assoc-list trie-filter))
(use-modules (srfi srfi-9) (srfi srfi-11))
